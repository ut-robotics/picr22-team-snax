...
[source,java]
----
 include::{sourcedir}/picr22-team-snax/electronics/Project Outputs for picr22-team-snax-mainboard/
----

PCB:
[source,java]
----
include::{sourcedir}/picr22-team-snax/electronics/picr22-team-snax-mainboard.PrjPcb
----