...
2. Brief description of game logic and code structure



3. Block diagram of game logic 

TODO

4. Short analysis of code quality
...
6. I suggest the instructors to keep hosting this course, because the practical skills taught by this course can't be learned from a lecture. Making things in real life teaches a lot. Also, I was impressed how professionally and seamlessly the course was taught, meaning everything from clea
